...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'accounts_myprofile', (
            ...
            ('college', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['clubs.College'], null=True)),
        ))
    ...
    models = {
        u'accounts.myprofile': {
            ...
            'college': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['clubs.College']", 'null': 'True'}),
