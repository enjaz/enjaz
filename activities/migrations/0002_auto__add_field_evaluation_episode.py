...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Evaluation.episode'
        db.add_column(u'activities_evaluation', 'episode',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['activities.Episode'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Evaluation.episode'
        db.delete_column(u'activities_evaluation', 'episode_id')
