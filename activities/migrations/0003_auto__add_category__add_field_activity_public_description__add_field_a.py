...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Activity.public_description'
        db.add_column(u'activities_activity', 'public_description',
                      self.gf('django.db.models.fields.TextField')(default=''),
                      keep_default=False)

        # Adding field 'Activity.category'
        db.add_column(u'activities_activity', 'category',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['activities.Category'], null=True, on_delete=models.SET_NULL),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Activity.public_description'
        db.delete_column(u'activities_activity', 'public_description')

        # Deleting field 'Activity.category'
        db.delete_column(u'activities_activity', 'category_id')
