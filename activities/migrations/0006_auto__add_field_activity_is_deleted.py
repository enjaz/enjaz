...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Activity.is_deleted'
        db.add_column(u'activities_activity', 'is_deleted',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Activity.is_deleted'
        db.delete_column(u'activities_activity', 'is_deleted')
