...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Evaluation.episode'
        db.alter_column(u'activities_evaluation', 'episode_id', self.gf('django.db.models.fields.related.ForeignKey')(default='', to=orm['activities.Episode']))

        # Changing field 'Evaluation.activity'
        db.alter_column(u'activities_evaluation', 'activity_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['activities.Activity'], null=True))

    def backwards(self, orm):

        # Changing field 'Evaluation.episode'
        db.alter_column(u'activities_evaluation', 'episode_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['activities.Episode'], null=True))

        # User chose to not deal with backwards NULL issues for 'Evaluation.activity'
        raise RuntimeError("Cannot reverse this migration. 'Evaluation.activity' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'Evaluation.activity'
        db.alter_column(u'activities_evaluation', 'activity_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['activities.Activity']))
