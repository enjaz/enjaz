...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Evaluation.activity'
        db.delete_column(u'activities_evaluation', 'activity_id')


    def backwards(self, orm):
        # Adding field 'Evaluation.activity'
        db.add_column(u'activities_evaluation', 'activity',
