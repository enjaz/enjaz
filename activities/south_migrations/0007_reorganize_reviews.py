...
class Migration(DataMigration):
    ...
    def get_presidency(self, orm):
        return orm['clubs.Club'].objects.get(english_name="Presidency")

    def get_dsa(self, orm):
        return orm['clubs.Club'].objects.get(english_name="Deanship of Student Affairs")
    ...
    def forwards(self, orm):
        ...
        for review in orm.Review.objects.all():
            if review.review_type == "P":
                review.reviewer_club = self.get_presidency(orm)
            elif review.review_type == "D":
                review.reviewer_club = self.get_dsa(orm)
            review.save()

    def backwards(self, orm):
        "Write your backwards methods here."
        orm.Review.objects.all().update(reviewer_club=None)
