...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'books_book', (
            ...
            ('available_to', self.gf('django.db.models.fields.CharField')(max_length=1)),
            ('submitter', self.gf('django.db.models.fields.related.ForeignKey')(related_name='book_contributions', null=True, on_delete=models.SET_NULL, to=orm['auth.User'])),
            ('holder', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='book_holdings', null=True, on_delete=models.SET_NULL, to=orm['auth.User'])),
    ...
    models = {
        ...
        u'books.book': {
            ...
            'available_to': ('django.db.models.fields.CharField', [], {'max_length': '1'}),
            ...
            'holder': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'book_holdings'", 'null': 'True', 'on_delete': 'models.SET_NULL', 'to': u"orm['auth.User']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'submitter': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'book_contributions'", 'null': 'True', 'on_delete': 'models.SET_NULL', 'to': u"orm['auth.User']"}),
