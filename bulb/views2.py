...
@decorators.ajax_only
@login_required
def edit_session(request, group_pk=None, session_pk):
    session = get_object_or_404(Session, pk=session_pk, is_deleted=False)
...
@login_required
@csrf.csrf_exempt
def delete_session(request, group_pk=None, session_pk):
...
def show_report(request, group_pk=None, session_pk):
...
@decorators.ajax_only
@login_required
def add_report(request, group_pk=None, session_pk):
    session = get_object_or_404(Session, pk=session_pk,
                                group__pk=group_pk,
                                group__is_deleted=False)
...
@decorators.ajax_only
@login_required
def edit_report(request, group_pk=None, session_pk):
