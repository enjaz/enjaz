...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Club.employee'
        db.add_column(u'clubs_club', 'employee',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='employee', on_delete=models.SET_NULL, default=None, to=orm['auth.User'], blank=True, null=True),
                      keep_default=False)

        # Adding field 'Club.college'
        db.add_column(u'clubs_club', 'college',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['clubs.College'], null=True, on_delete=models.SET_NULL, blank=True),
                      keep_default=False)


        # Changing field 'Club.coordinator'
        db.alter_column(u'clubs_club', 'coordinator_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL, to=orm['auth.User']))

    def backwards(self, orm):
        # Deleting field 'Club.employee'
        db.delete_column(u'clubs_club', 'employee_id')

        # Deleting field 'Club.college'
        db.delete_column(u'clubs_club', 'college_id')


        # Changing field 'Club.coordinator'
        db.alter_column(u'clubs_club', 'coordinator_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['auth.User']))
