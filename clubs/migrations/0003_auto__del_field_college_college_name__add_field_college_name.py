...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'College.college_name'
        db.delete_column(u'clubs_college', 'college_name')

        # Adding field 'College.name'
        db.add_column(u'clubs_college', 'name',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=1),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'College.college_name'
        db.add_column(u'clubs_college', 'college_name',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=1),
                      keep_default=False)

        # Deleting field 'College.name'
        db.delete_column(u'clubs_college', 'name')
