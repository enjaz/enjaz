...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Club.city'
        db.add_column(u'clubs_club', 'city',
                      self.gf('django.db.models.fields.CharField')(default='R', max_length=1),
                      keep_default=False)

        # Adding field 'College.city'
        db.add_column(u'clubs_college', 'city',
                      self.gf('django.db.models.fields.CharField')(default='R', max_length=1),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Club.city'
        db.delete_column(u'clubs_club', 'city')

        # Deleting field 'College.city'
        db.delete_column(u'clubs_college', 'city')
