...
def add_deanships(apps, schema_editor):
    ...
    year_2015_2016 = StudentClubYear.objects.get(start_date__year=2015,
                                                 end_date__year=2016)
    jeddah_presidency = Club.objects.get(english_name="Presidency (Jeddah)",
                                         year=year_2015_2016)
    alahsa_presidency = Club.objects.get(english_name="Presidency (Al-Ahsa)",
                                         year=year_2015_2016)
    ...
    j_m_m_c = Club.objects.get(english_name="College of Medicine",
                               gender="M", year=year_2015_2016,
                               city="J")
    j_n_f_c = Club.objects.get(english_name="College of Nursing",
                               gender="F", year=year_2015_2016,
                               city="J")
    ...
    jeddah_deanships = [j_m_m_d, j_n_f_d, j_b_m_d, j_b_f_d]
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('clubs', '0020_club_possible_parents'),
    ]
