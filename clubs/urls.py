...
urlpatterns = patterns('',
    ...
    url(r'^(?P<club_id>\d+)/privileges/$', views.view_privileges, name='view_privileges'),
    url(r'^(?P<club_id>\d+)/privileges/control$', views.control_privileges, name='control_privileges'),
