...
class Abstract(models.Model):
    ...
    #Study Information
    principle_investigator = models.CharField(verbose_name="Principle Investigator", max_length=255, null=True)
    ...
    irb_approval = models.BooleanField(verbose_name="IRB Approval", default=False)
