...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Form.content_type'
        db.add_column(u'forms_form', 'content_type',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['contenttypes.ContentType'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'Form.object_id'
        db.add_column(u'forms_form', 'object_id',
                      self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Form.content_type'
        db.delete_column(u'forms_form', 'content_type_id')

        # Deleting field 'Form.object_id'
        db.delete_column(u'forms_form', 'object_id')
