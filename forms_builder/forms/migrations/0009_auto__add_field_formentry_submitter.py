...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'FormEntry.submitter'
        db.add_column(u'forms_formentry', 'submitter',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name=u'form_entries', null=True, to=orm['auth.User']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'FormEntry.submitter'
        db.delete_column(u'forms_formentry', 'submitter_id')
    ...
    models = {
        ...
        u'forms.formentry': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'submitter': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "u'form_entries'", 'null': 'True', 'to': u"orm['auth.User']"})
        },
        u'sites.site': {
