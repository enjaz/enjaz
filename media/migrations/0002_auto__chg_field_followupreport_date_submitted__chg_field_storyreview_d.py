...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'FollowUpReport.date_submitted'
        db.alter_column(u'media_followupreport', 'date_submitted', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

        # Changing field 'StoryReview.date_reviewed'
        db.alter_column(u'media_storyreview', 'date_reviewed', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

        # Changing field 'Story.date_submitted'
        db.alter_column(u'media_story', 'date_submitted', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

        # Changing field 'ArticleReview.date_reviewed'
        db.alter_column(u'media_articlereview', 'date_reviewed', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

        # Changing field 'Article.date_submitted'
        db.alter_column(u'media_article', 'date_submitted', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

    def backwards(self, orm):

        # Changing field 'FollowUpReport.date_submitted'
        db.alter_column(u'media_followupreport', 'date_submitted', self.gf('django.db.models.fields.DateField')(auto_now_add=True))

        # Changing field 'StoryReview.date_reviewed'
        db.alter_column(u'media_storyreview', 'date_reviewed', self.gf('django.db.models.fields.DateField')(auto_now_add=True))

        # Changing field 'Story.date_submitted'
        db.alter_column(u'media_story', 'date_submitted', self.gf('django.db.models.fields.DateField')(auto_now_add=True))

        # Changing field 'ArticleReview.date_reviewed'
        db.alter_column(u'media_articlereview', 'date_reviewed', self.gf('django.db.models.fields.DateField')(auto_now_add=True))

        # Changing field 'Article.date_submitted'
        db.alter_column(u'media_article', 'date_submitted', self.gf('django.db.models.fields.DateField')(auto_now_add=True))
