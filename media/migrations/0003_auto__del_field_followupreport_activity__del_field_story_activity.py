...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'FollowUpReport.activity'
        db.delete_column(u'media_followupreport', 'activity_id')

        # Deleting field 'Story.activity'
        db.delete_column(u'media_story', 'activity_id')


    def backwards(self, orm):
        # Adding field 'FollowUpReport.activity'
        db.add_column(u'media_followupreport', 'activity',
                      self.gf('django.db.models.fields.related.ForeignKey')(default='', to=orm['activities.Activity']),
                      keep_default=False)

        # Adding field 'Story.activity'
        db.add_column(u'media_story', 'activity',
                      self.gf('django.db.models.fields.related.ForeignKey')(default='', to=orm['activities.Activity']),
                      keep_default=False)
