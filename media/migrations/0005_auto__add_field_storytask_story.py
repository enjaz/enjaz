...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'StoryTask.story'
        db.add_column(u'media_storytask', 'story',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['media.Story'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'StoryTask.story'
        db.delete_column(u'media_storytask', 'story_id')
    ...
    models = {
        ...
        u'media.storytask': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'story': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['media.Story']", 'null': 'True', 'blank': 'True'})
        }
    }
