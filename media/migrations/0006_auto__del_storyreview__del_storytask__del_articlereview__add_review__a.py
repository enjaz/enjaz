...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'Review'
        db.create_table(u'media_review', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('reviewer', self.gf('django.db.models.fields.related.ForeignKey')(related_name='media_review_set', to=orm['auth.User'])),
        ...
        db.send_create_signal(u'media', ['Review'])

        # Adding field 'Story.review'
        db.add_column(u'media_story', 'review',
                      self.gf('django.db.models.fields.related.OneToOneField')(to=orm['media.Review'], unique=True, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Story.assignee'
        db.add_column(u'media_story', 'assignee',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='story_assignments', null=True, to=orm['auth.User']),
                      keep_default=False)

        # Adding field 'Article.review'
        db.add_column(u'media_article', 'review',
                      self.gf('django.db.models.fields.related.OneToOneField')(to=orm['media.Review'], unique=True, null=True, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.create_table(u'media_storytask', (
            ...
            ('story', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['media.Story'], null=True, blank=True)),
        ...
        db.delete_table(u'media_review')

        # Deleting field 'Story.review'
        db.delete_column(u'media_story', 'review_id')

        # Deleting field 'Story.assignee'
        db.delete_column(u'media_story', 'assignee_id')

        # Deleting field 'Article.review'
        db.delete_column(u'media_article', 'review_id')
    ...
    models = {
        ...
        u'media.article': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'review': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['media.Review']", 'unique': 'True', 'null': 'True', 'blank': 'True'}),
        ...
        u'media.review': {
            ...
            'reviewer': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'media_review_set'", 'to': u"orm['auth.User']"})
        },
        u'media.story': {
            'Meta': {'object_name': 'Story'},
            'assignee': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'story_assignments'", 'null': 'True', 'to': u"orm['auth.User']"}),
            'date_submitted': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'episode': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['activities.Episode']", 'unique': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'review': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['media.Review']", 'unique': 'True', 'null': 'True', 'blank': 'True'}),
