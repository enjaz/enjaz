...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Article.writer'
        db.delete_column(u'media_article', 'writer_id')

        # Adding field 'Article.author'
        db.add_column(u'media_article', 'author',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name=u'authored_articles', to=orm['auth.User']),
                      keep_default=False)

        # Adding field 'Article.status'
        db.add_column(u'media_article', 'status',
                      self.gf('django.db.models.fields.CharField')(default='P', max_length=1),
                      keep_default=False)

        # Adding field 'Article.assignee'
        db.add_column(u'media_article', 'assignee',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Article.writer'
        db.add_column(u'media_article', 'writer',
                      self.gf('django.db.models.fields.related.ForeignKey')(default='', to=orm['auth.User']),
                      keep_default=False)

        # Deleting field 'Article.author'
        db.delete_column(u'media_article', 'author_id')

        # Deleting field 'Article.status'
        db.delete_column(u'media_article', 'status')

        # Deleting field 'Article.assignee'
        db.delete_column(u'media_article', 'assignee_id')
