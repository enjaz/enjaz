...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'FollowUpReport.images'
        db.delete_column(u'media_followupreport', 'images')


    def backwards(self, orm):
        # Adding field 'FollowUpReport.images'
        db.add_column(u'media_followupreport', 'images',
