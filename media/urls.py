...
urlpatterns = patterns('',
    ...
    url(r'^activities/reports/(?P<episode_pk>\d+)/employee_report/$', views.show_employee_report, name="show_employee_report"),
    url(r'^activities/reports/(?P<episode_pk>\d+)/$', views.show_report, name="show_report"),
    url(r'^activities/reports/(?P<episode_pk>\d+)/edite_mployee_report/$', views.edit_employee_report, name="edit_employee_report"),
