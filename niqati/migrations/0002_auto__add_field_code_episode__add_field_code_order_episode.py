...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Code.episode'
        db.add_column(u'niqati_code', 'episode',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['activities.Episode'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'Code_Order.episode'
        db.add_column(u'niqati_code_order', 'episode',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['activities.Episode'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Code.episode'
        db.delete_column(u'niqati_code', 'episode_id')

        # Deleting field 'Code_Order.episode'
        db.delete_column(u'niqati_code_order', 'episode_id')
