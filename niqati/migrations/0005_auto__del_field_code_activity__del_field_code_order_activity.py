...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Code.activity'
        db.delete_column(u'niqati_code', 'activity_id')

        # Deleting field 'Code_Order.activity'
        db.delete_column(u'niqati_code_order', 'activity_id')


    def backwards(self, orm):
        # Adding field 'Code.activity'
        db.add_column(u'niqati_code', 'activity',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['activities.Activity'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'Code_Order.activity'
        db.add_column(u'niqati_code_order', 'activity',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['activities.Activity'], null=True, blank=True),
                      keep_default=False)
