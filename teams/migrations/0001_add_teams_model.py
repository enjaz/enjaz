    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('logo', models.ImageField(null=True, upload_to=b'clubs/logos/', blank=True)),
                ('description', models.TextField(verbose_name='\u0627\u0644\u0648\u0635\u0641', blank=True)),
                ('club', models.ForeignKey(related_name='club_teams', verbose_name='\u0627\u0644\u0646\u0627\u062f\u064a \u0627\u0644\u0645\u062a\u0635\u0644', blank=True, to='clubs.Club', null=True)),
                ...
                ('coordinator', models.ForeignKey(related_name='teams_coordination', on_delete=django.db.models.deletion.SET_NULL, verbose_name='\u0627\u0644\u0645\u0646\u0633\u0642', blank=True, to=settings.AUTH_USER_MODEL, null=True)),
                ('members', models.ManyToManyField(related_name='teams_memberships', verbose_name='\u0627\u0644\u0623\u0639\u0636\u0627\u0621', to=settings.AUTH_USER_MODEL, blank=True)),
                ('parent', models.ForeignKey(related_name='children', on_delete=django.db.models.deletion.SET_NULL, default=None, blank=True, to='teams.Teams', null=True, verbose_name='\u0627\u0644\u0646\u0627\u062f\u064a \u0627\u0644\u0623\u0628')),
