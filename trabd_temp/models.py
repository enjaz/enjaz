...
position_choices = (
    ...
    ('4R', 'رئيس المركز الإعلامي في الرياض'),
    ('5R', 'رئيسة المركز الإعلامي في الرياض'),
    ...
    ('45R', 'رئيس النادي الرياضي في الرياض'),
    ('46R', 'رئيسة النادي الرياضي في الرياض'),
    ('47R', 'رئيس مبادرة سراج في الرياض'),
    ('48R', 'رئيسة مبادرة سراج في الرياض'),
    ...
    ('4J', 'رئيس المركز الإعلامي في جدة'),
    ('5J', 'رئيسة المركز الإعلامي في جدة'),
    ...
    ('43J', 'رئيس النادي الرياضي في جدة'),
    ('44J', 'رئيسة النادي الرياضي في جدة'),
    ('45J', 'رئيس مبادرة سراج في جدة'),
    ('46J', 'رئيسة مبادرة سراج في جدة'),
    ...
    ('4A', 'رئيس المركز الإعلامي في الأحساء'),
    ('5A', 'رئيسة المركز الإعلامي في الأحساء'),
    ...
    ('41A', 'رئيس مبادرة سراج في الأحساء'),
    ('42A', 'رئيسة مبادرة سراج في الأحساء'),
